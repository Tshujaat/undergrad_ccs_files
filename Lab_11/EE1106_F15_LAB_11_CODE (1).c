...
int main(void)
{
	...
	P1DIR |= 0x01;											// Set P1.6 as output
	P1OUT |= 0x00;											// Set P1.6 to low
	P1SEL |= 0x01;											// Select P1.6 for PWM output
...
{
	if(TACCR1 == 4000)										// Slowly increase PWM duty cycle, reset to 10% duty cycle at 80% duty cycle
	{
		TACCR1 = 500;
	}
	else
