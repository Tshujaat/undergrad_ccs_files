...

{
    ...
    ADC14->MCTL[4] = ADC14_MCTLN_VRSEL_0  | ADC14_MCTLN_INCH_4 ;   //A4/P5.1/C4
    ...
    ADC14->MCTL[12] = ADC14_MCTLN_VRSEL_0  | ADC14_MCTLN_INCH_12 ;   //A12/P4.1/R1
    ...
    while (1)
    {
      ...
      ADCvarR1 = ADC14->MEM[12];                       // Read conversion result from row 1 aka A12/P4.1
      fADCvarR1 = (3.3*ADCvarR1)/(4095.0) - 3.25;

      ADCvarR2 = ADC14->MEM[13];                       // Read conversion result from row 2 aka A13/P4.0
      fADCvarR2 = (3.3*ADCvarR2)/(4095.0) - 0.02;
